...
const validateLeaveRequest = [
  ...
  body('type').isIn(['annual', 'sick', 'unpaid']).withMessage('Loại nghỉ phép không hợp lệ'),
  ...
  body('remainingDays').isInt({ min: 0 }).withMessage('Số ngày nghỉ còn lại phải là số nguyên dương')
];

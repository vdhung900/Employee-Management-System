  ...
  return (
    <Layout style={{ minHeight: '100vh' }}>
      ...
      >
        ...
        <div className="sider-menu-wrapper" style={{ padding: collapsed ? '0 8px' : '0 20px', height: 'auto', overflow: 'visible', marginTop: 20, paddingBottom: 20 }}>
          <Menu
            mode="inline"
          ...
          <Space size="large" align="center">
            ...
            >
              <Badge count={3} overflowCount={99}>
                <ThreeDButton type="text" icon={<BellOutlined style={{ color: '#1976d2' }} />} size="large" />
              </Badge>
            </Dropdown>
            <Dropdown
              menu={{

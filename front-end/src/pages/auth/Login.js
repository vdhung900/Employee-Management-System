...
import { UserOutlined, LockOutlined, GoogleOutlined, MailOutlined, LoginOutlined } from '@ant-design/icons';
          ...
          <Text style={{ color: "#666", display: "block", fontSize: "16px" }}>
            ...
            >
                ...
                >
                    ...
                    <Title level={2} className="enhanced-title" style={{ margin: '0 0 8px 0', fontSize: '28px', color: '#1976d2' }}>
                        Đăng nhập
                    </Title>
                    <Text style={{ color: '#666', display: 'block', fontSize: '16px' }}>
                        Hệ thống Quản lý Chấm công
